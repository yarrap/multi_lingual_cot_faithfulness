"""
qwen3_mgsm_vllm_cot.py
========================
MGSM CoT evaluation for Qwen3-4B using vLLM + 3-run majority voting.
"""
...
def parse_answer(cot_text: str, answer_prefix: str, lang: str = "") -> tuple[str, str]:
    ...
    def line_has_prefix(line: str) -> bool:
        ...
        if lang == "zh":
            return normalize_zh(answer_prefix) in normalize_zh(clean)
        return answer_prefix in clean
...
sampling_params = SamplingParams(
    ...
    repetition_penalty=1.15,  # fixes infinite repetition loops in low-resource languages
)
print("Model loaded.\n")
